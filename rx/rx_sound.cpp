...
void c2s_sound(void *param)
{
    ...
    case FW_SEL_SDR_RX3_WF3: {
        const double target = 15960.828e-6;      // empirically measured using GPS 1 PPS input
    ...
    while (TRUE) {
        ...
        do {
            ...
            } else if (mode != MODE_DRM) { // all other modes
